...
; This environment exists entirely within the apply-env procedure.
; Extend-env-rec is implemented within as well.
(define apply-env
...
(define value-of
  (lambda (exp env)
    (cases expression exp
      ...
      (letrec-exp (pname bvar pbody letrec-body)
                  (value-of letrec-body
                            (extend-env-rec pname bvar pbody env))))))
